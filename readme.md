...
* [Баесовский наивный классификатор](#баесовский-наивный-классификатор)
...
Дано: - 1-го признака, - 2-го признака, длина выборки(количество точек), мат ожидание 
...
2) Считаем мат ожидание и дисперсию для новой выборки.

3) Классифицируем точки и рисуем график
