...
# Байесовские алгоритмы классификации
 ...
 из которого случайно и независимо извлекаются *l* наблюдений, где Р- априорная вероятность, р(х/у)= р(х)- функцинал правдоподобия
  ...
  Если известны априорные вероятности классов 𝑃 и функции правдоподобия 𝑝(𝑥), то минимум среднего риска достигается алгоритмом  
  
  ![](http://latex.codecogs.com/gif.latex?a%28x%29%20%3D%20arg%5Cmax_%7By%5Cin%20Y%7D%20%5CLambda_y%20P_y%20p_y%28x%29)
  
 ## Линии уровня
  
 Дано ковариационная матрица(2х2) 2 признаков
