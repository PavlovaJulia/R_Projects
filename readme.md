...
# Байесовские алгоритмы классификации
 ...
 Построить линии уровня для ковариационной матрице с нормальным распределением
...
1) Определитель ковариационной матрицы должен быть положительный.

[2) Если ковариационная матрица диагональная, тогда линии уровня будут выглядеть как круги.](https://pavlovajulia.shinyapps.io/line_level/)

[3) Если в ковариационная матрица не диагональна, тогда круги будут вытягиваться в виде элипсов зависимости от того какой признак больше.](https://pavlovajulia.shinyapps.io/line_level/)

[4) Также элементы ковариационной матрицы а12 и а21 отвечают за поворот элипсов](https://pavlovajulia.shinyapps.io/line_level/)
