...
[1) Определитель ковариационной матрицы должен быть положительный.](https://pavlovajulia.shinyapps.io/line_level/)

2) Если ковариационная матрица диагональная, тогда линии уровня будут выглядеть как круги

3) Если в ковариационная матрица не диагональна, тогда круги будут вытягиваться в виде элипсов зависимости от того какой признак больше.

4) Также элементы ковариационной матрицы а12 и а21 отвечают за поворот элипсов
