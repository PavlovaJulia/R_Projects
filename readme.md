...
Мы берем функция потерь: *L(M) = (M-1)^2*, правило обновление весов: 
*![](http://latex.codecogs.com/gif.latex?w%20%3D%20w%20-%20%5Ceta%20%28%3Cw%2Cx_i%3E%20-%20y_i%29x_i)*  и проделываем все пункты из выше изложенного алгоритма. 
...
Мы берем функция потерь: ![](http://latex.codecogs.com/gif.latex?L%28M%29%3D%28-M%29_&plus;), правило обновление весов: если ![](http://latex.codecogs.com/gif.latex?%3Cw%2Cx_i%3Ey_i%3C0)
то ![](http://latex.codecogs.com/gif.latex?w%20%3D%20w%20&plus;%20%5Ceta%20x_iy_i)   и проделываем все пункты из выше изложенного алгоритма. 

Результат работы программы можно посмотреть [здесь](https://pavlovajulia.shinyapps.io/pravilo_xebba/)

Пример работы программы:

![](https://github.com/PavlovaJulia/R_Projects/blob/master/lab2/PraviloXebba.PNG)

## Логистическая регрессия

Мы берем функция потерь: *L(M) = log2(1 + exp(-M))*, правило обновление весов: 
*![](http://latex.codecogs.com/gif.latex?w%20%3D%20w%20&plus;%20%5Ceta%20x_iy_i%5Csigma%20%28-%3Cw%2Cx_i%3Ey_i%29)*  и проделываем все пункты из выше изложенного алгоритма. 

Результат работы программы можно посмотреть [здесь](https://pavlovajulia.shinyapps.io/logregressiya/)

Пример работы программы:

![](https://github.com/PavlovaJulia/R_Projects/blob/master/lab2/Log_regr.PNG)

Карта классификации для логистической регресии

![](https://github.com/PavlovaJulia/R_Projects/blob/master/lab2/log_klass.PNG)

### Сравнение линейных алгоритмов классификации

Можно сравнивать их когда выборка разделима, и когда не разделима

![](https://github.com/PavlovaJulia/R_Projects/blob/master/lab2/Sravnenie.PNG)

В этом случает выборка разделима. Все эти алгоритмы не допускают ошибок. Но логистическая регрессия лучше, так как линия находится на оптимальном расстоянии от одного класса и другого.

![](https://github.com/PavlovaJulia/R_Projects/blob/master/lab2/Sravnenie2.PNG)

В случае когда выборка не разделима меньше всего ошибок допустил алгоритм ADALine(3) и логистическая регрессия(3) и достаточно много ошибок допустил алгоритм правило-хэбба(8) 
