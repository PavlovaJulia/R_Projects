...
2) Вычислить начальное значение функционала потерь
...
7) получить новое значение функционала потерь

8) пока значение функционала потерь не стабилизируются или веса не перестанут изменяться.
